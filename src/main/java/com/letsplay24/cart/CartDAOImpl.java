...
List l = sessionFactory.getCurrentSession().createQuery("from Cart where ProductID = :id").setInteger("id", cartProductID).list();
	...
	public List<Cart> getCartByUserName(String UserName) {
		// TODO Auto-generated method stub
		return sessionFactory.getCurrentSession().createQuery("from Cart as c where c.UserName0= :user").setString("user",UserName ).list();
	}
	...
	public List<Cart> getProduct() {
		// TODO Auto-generated method stub
		return sessionFactory.getCurrentSession().createQuery("from Cart as c").list();
	}
}
